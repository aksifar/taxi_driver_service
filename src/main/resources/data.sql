...
-- Create 3 reserved/selected cars
...
insert into car (id, date_created, license_plate, seat_count, convertible, rating, engine_type ,make, selected) values (2, now(), 'BKW 1001', 6, false, 3.0, 'GAS', 'BENZ', true);

insert into car (id, date_created, license_plate, seat_count, convertible, rating, engine_type ,make, selected) values (3, now(), 'BKW 1002', 4, true, 5.0, 'ELECTRIC', 'DAIMLER', true);

-- Create 3 un-selected/un-reserved cars
